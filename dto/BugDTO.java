...
public class BugDTO {
	...
	public String toString() {
		return "BugDTO [bugId=" + bugId + ", bugTitle=" + bugTitle + ", bugDescription=" + bugDescription
				+ ", severity=" + severity + ", createdBy=" + createdBy + ", assignTo=" + assignTo + ", status="
				+ status + ", startDate=" + startDate + ", lastUpdatedDate=" + lastUpdatedDate + ", project=" + project
				+ "]";
	}
